...
import { Search, MapPin, DollarSign, Clock, Users, Plus, BarChart3, Briefcase, TrendingUp } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex gap-3">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white border-0 rounded-lg px-6 flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge className="bg-amber-100 text-amber-700 border border-amber-200 rounded-lg">
        ...
        {filteredJobs.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-emerald-300">Try adjusting your search terms</p>
          </div>
        )}
      </div>
    </div>
